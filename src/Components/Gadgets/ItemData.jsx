...
function ProductData({ product, subcategories, viewSpecifications, showSubcategory }) {
    ...
    const scale = useTransform(scrollYProgress, [0.02, 0.08], [0.9, 0.95]);
    ...
    return (
        <motion.div className='flex flex-col justify-center border bg-white  rounded-lg h-[95%] w-full p-[28px] m-[6px]' style={{ scale, opacity }}>
