            ...
            {loading ? (
                ...
                <div className='grid grid-cols-1 xsx:grid-cols-12'>
                    <div className=' xsx:col-span-5 flex flex-col justify-center'>
                        ...
                        <div className='scale-[0.7] my-[-15px]'>
                            {profileImage !== null ? (
                                <div>
                        ...
                        {editMode ? (
                                    ...
                                    <div className="flex items-center space-x-4 bg-white mb-[15px] p-4 rounded-lg shadow-sm">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className='border border-gray-300 p-2 bg-gray-100 file:bg-gray-950 file:my-[4px] file:text-gray-100 file:rounded-xl file:px-[15px] file:mr-[15px] rounded'
                                                accept="image/jpeg"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center space-x-4 bg-white mb-[15px] p-4 rounded-lg shadow-sm">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className='mt-[8px] bg-gray-100 font-[600]  rounded-xl p-[10px] text-2xl text-gray-700'
                            ...
                            <div className="flex w-full flex-col">
                                ...
                                <div className='flex scale-[0.75] '>
                                    <button className='md:ml-[-75px] mt-[22px] bg-blue-950 rounded-3xl py-[8px] px-[18px]  text-lg xsx:text-2xl text-white font-medium' onClick={() => setEditMode(true)}>Edit Profile</button>
                    ...
                    <div className='xsx:col-span-7 flex flex-col no-scrollbar xsx:overflow-y-auto xsx:h-[calc(98vh-85px)]'>
                        <div className='w-[100%] xsx:mt-[15px] my-[15px] flex scale-[0.8] text-lg md:text-2xl'>
                            <p onClick={() => setActiveTab('reviews')}
                                className={`cursor-pointer mr-[15px] px-[8px] md:px-[15px] py-[4px] transition duration-200 font-[600] rounded-[25px] ${activeTab === 'reviews' ? 'bg-gray-800 text-white ' : 'bg-white border border-gray-400 text-black'}`} >
                                Liked Reviews
                            </p>
                            <p onClick={() => setActiveTab('products')}
                                className={`cursor-pointer px-[8px] md:px-[15px]  py-[4px] font-[600] rounded-[25px] ${activeTab === 'products' ? 'bg-gray-800 text-white ' : 'bg-white border border-gray-400 text-black'}`} >
                                Liked Products
                            </p>
